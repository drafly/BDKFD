...
def train_model_FedAvg_FMLDKD(model, local_model, trn_x, trn_y, tst_x, tst_y, learning_rate, batch_size, epoch, print_per,
...
def train_model_prox_FMLDKD(model,local_model,  cld_mdl_param, trn_x, trn_y, tst_x, tst_y, learning_rate, batch_size, epoch, print_per,
                     weight_decay, dataset_name,a, b, alpha, beta, temperature,  sch_step=1, sch_gamma=1):
    n_trn = trn_x.shape[0]
    trn_gen = data.DataLoader(Dataset(trn_x, trn_y, train=True, dataset_name=dataset_name), batch_size=batch_size,
                              shuffle=True)
...
def train_model_FedDyn_FMLDKD(model,local_model, model_func,model_local_func,alpha_coef, avg_mdl_param, hist_params_diff, trn_x, trn_y,
...
def train_model_FedDC_FMLDKD(model, local_model,model_func, model_local_func,alpha_py, local_update_last, global_update_last, global_model_param, hist_i,
                      trn_x, trn_y,
                      learning_rate, batch_size, epoch, print_per,
                      weight_decay, dataset_name, a, b, alpha, beta, temperature, sch_step, sch_gamma):
    n_trn = trn_x.shape[0]
